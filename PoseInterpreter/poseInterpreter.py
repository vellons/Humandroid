...
class PoseInterpreter:
    ...
    # Style configuration
    POSE_CONN_THICKNES = 2
    POSE_CONN_LEFT_COLOR = (60, 179, 113)
    POSE_CONN_RIGHT_COLOR = (255, 165, 0)
    POSE_CONN_DEFAULT_COLOR = (255, 255, 255)

    POSE_LANDMARKS_THICKNESS = 3
    POSE_LANDMARKS_CIRCLE_RADIUS = 3
    POSE_LANDMARKS_LEFT_COLOR = (60, 179, 113)
    POSE_LANDMARKS_RIGHT_COLOR = (255, 165, 0)
    POSE_LANDMARKS_NOSE_COLOR = (255, 48, 48)

    ANGLE_TEXT_FONT = 0.8
    ANGLE_TEXT_THICKNESS = 2
    ANGLE_TEXT_MARGIN = 40
    ...
    PLOT_CONN_LEFT_COLOR = (60, 179, 113)
